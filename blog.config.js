...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '后端程序员，网安爱好者🧑‍💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'DopamineNone,blog,博客,技术笔记,编程学习,计算机技术,软件逆向,漏洞分析,学习记录,Coding,CS Notes,Cybersecurity,AI,Personal Thoughts', // 网站关键词 英文逗号隔开
